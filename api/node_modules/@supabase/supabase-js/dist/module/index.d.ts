...
export { default as SupabaseClient } from '@supabase/supabase-js/dist/module/SupabaseClient';
export type { SupabaseClientOptions, QueryResult, QueryData, QueryError } from '@supabase/supabase-js/dist/module/lib/types';
/**
